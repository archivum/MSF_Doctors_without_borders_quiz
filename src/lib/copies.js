const copies = {
    ...
    quiz_form:
        {
          ...
          check: 'Join our supporters so you\'ll be the first to know when a crisis occurs. MSF may contact you about different opportunities to help. You can unsubscribe at any time. Your privacy is important to us.',
          check_link: 'Learn more here.',
          check_phone_removed: 'Join our supporters so you\'ll be the first to know when a crisis occurs. MSF may contact you about different opportunities to help. You can unsubscribe at any time. Your privacy is important to us.',
          continue: 'continue',
          skip: 'Skip this step',
          f_name: 'First Name*',
          l_name: 'Last Name',
  ...
  fr: {
    start:
        {
          line1: 'JEU-QUESTIONNAIRE DE',
          line2: 'MÉDECINS SANS FRONTIÈRES',
          line3: 'Quel type de travailleur',
    ...
    quiz_form:
        {
          ...
          check_link: 'Pour plus de détails, cliquez ici.',
          check_phone_removed: 'Choisissez de rejoindre notre communauté d\'humanitaires. Vous pouvez vous désinscrire à tout moment. Nous accordons beaucoup d\'importance au respect de votre vie privée.',
          continue: 'continuer',
