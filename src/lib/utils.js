...
const quiz_fr = {
    ...
    questions: [{
      ...
      responses: [{
        ...
        value: 6,
        val_2: 'Vous êtes enthousiaste à l\'idée d\'élargir votre vision du monde.'
      },
        {
          text: 'Vous vous lancez dans un débat animé —\n vous aimez une bonne discussion.',
          value: 8,
          val_2: 'Vous vous lancez dans un débat animé -- vous aimez une bonne discussion.'
        },
        {
          text: 'Vous écoutez attentivement, en essayant de comprendre toutes les perspectives.',
          value: 2,
          val_2: 'Vous écoutez attentivement, en essayant de comprendre toutes les perspectives.'
        },
        {
          text: 'Vous écoutez bien, vous donnez souvent votre avis, vous invitez tout le monde à s\'exprimer.',
          value: 4,
          val_2: 'Vous écoutez bien, vous donnez souvent votre avis, vous invitez tout le monde à s\'exprimer.'
        }
      ]
    },
      {
        ...
        responses: [{
          ...
          value: 6,
          val_2: 'Vous parcourez le web pour trouver des articles provenant de diverses sources.'
        },
          {
            text: 'Vous lisez et commentez tout ce que vous pouvez trouver.',
            value: 4,
            val_2: 'Vous lisez et commentez tout ce que vous pouvez trouver.'
          },
          {
            text: 'Allez toujours vers vos sources favorites, qui sont les plus réputées.',
            value: 8,
            val_2: 'Allez toujours vers vos sources favorites, qui sont les plus réputées.'
          },
          {
            text: 'Vous lisez et partagez beaucoup sur les médias sociaux dans le but de faire connaître les grands enjeux.',
            value: 2,
            val_2: 'Vous lisez et partagez beaucoup sur les médias sociaux dans le but de faire connaître les grands enjeux.'
          }
        ]
      },
      {
        ...
        responses: [{
          ...
          value: 6,
          val_2: 'proposez de devenir bénévole.'
        },
          {
            text: 'proposez de lancer une campagne de collecte de fonds.',
            value: 4,
            val_2: 'proposez de lancer une campagne de collecte de fonds.'
          },
          {
            text: 'consultez la section « À propos de nous » de leur site web.',
            value: 2,
            val_2: 'consultez la section « À propos de nous » de leur site web.'
          },
          {
            text: 'proposez de faire du porte-à-porte avec une pétition pour sensibiliser le public.',
            value: 8,
            val_2: 'proposez de faire du porte-à-porte avec une pétition pour sensibiliser le public.'
          }
        ]
      },
      {
        ...
        responses: [{
          ...
          value: 6,
          val_2: 'signez immédiatement la pétition sans la lire.'
        },
          {
            text: 'signez et offrez de partager la pétition avec vos amis sur les réseaux sociaux.',
            value: 4,
            val_2: 'signez et offrez de partager la pétition avec vos amis sur les réseaux sociaux.'
          },
          {
            text: 'proposez de lire la pétition et de réfléchir aux implications de la signature.',
            value: 2,
            val_2: 'proposez de lire la pétition et de réfléchir aux implications de la signature.'
          },
          {
            text: 'signez, puis frappez aux portes pour recruter plus de voisins en soutien à la cause.',
            value: 8,
            val_2: 'signez, puis frappez aux portes pour recruter plus de voisins en soutien à la cause.'
          }
        ]
      },
      {
        ...
        responses: [{
          ...
          value: 6,
          val_2: 'Un projecteur portatif pour regarder vos films préférés.'
        },
          {
            text: 'Des haut-parleurs pour votre lecteur de musique.',
            value: 8,
            val_2: 'Des haut-parleurs pour votre lecteur de musique.'
          },
          {
            text: 'Vos romans préférés.',
            value: 2,
            val_2: 'Vos romans préférés.'
          },
          {
            text: 'Un jeu de cartes.',
            value: 4,
            val_2: 'Un jeu de cartes.'
          }
        ]
      },
    ]
