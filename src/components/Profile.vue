  ...
  export default {
    ...
    computed: {
        ...
        twitterMessage() {
            ...
            return (this.$i18n.locale === 'en') ? `https://twitter.com/intent/tweet?text=` + twitterBlurb + `%20http%3A//quiz.doctorswithoutborders.ca` : `https://twitter.com/intent/tweet?text=` + twitterBlurb + `%20http%3A//quiz.doctorswithoutborders.ca/?lang=fr`;
        }
    },
    methods: {
        showModal () {
