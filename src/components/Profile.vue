...
import {profiles} from '../lib/utils.js'
  ...
  export default {
    ...
    computed: {
        ...
        twitterMessage() {
            return `https://twitter.com/intent/home?status=I%20am%20` + this.profileName + `.%20Take%20the%20Doctors%20Without%20Borders%20Quiz%20and%20find%20out%20what%20kind%20of%20aid%20worker%20you%20are.http%3A//msfquiz.candy-staging.com`
        }
    },
    methods: {
        showModal () {
